...
```
build-iso-aarch64.ps1 (✅ MAIN - Use this)
build-iso-final.ps1 (x86_64 version)
build-iso.ps1 (x86_64 version)
build-iso.sh (Linux version)
```
...
# Mount: iso-output/rayos-aarch64.iso
...
2. Choose Option A (Quick PoC), B (Proper Kernel), or C (Linux-based)
...
| `volume/src/main.rs`               | Storage engine             | ✅ Implemented |
...
# Check ISO
Get-Item iso-output\rayos-aarch64.iso
```
