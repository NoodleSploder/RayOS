...
**File**: `build/rayos-aarch64.iso` (7.88 MB)
...
4. ISO Image: `build/rayos-aarch64.iso`
5. Type: Linux
...
4. Select: `build/rayos-aarch64.iso`
...
# Add DVD drive
Add-VMDvdDrive -VMName $vmName -Path "$(Get-Location)\build\rayos-aarch64.iso"
