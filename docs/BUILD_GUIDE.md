...
✅ **ISO Successfully Created**: `build/rayos.iso` (7.88 MB)
...
$IsoPathWSL = "/mnt/c/Users/caden/Documents/Programming Scripts/Personal/Rust/ray-os/build/rayos.iso"
$IsoContentPathWSL = "/mnt/c/Users/caden/Documents/Programming Scripts/Personal/Rust/ray-os/build/iso-content"
...
Add-VMDvdDrive -VMName RayOS -Path "C:\Users\caden\Documents\Programming Scripts\Personal\Rust\ray-os\build\rayos.iso"
...
3. In Rufus:
   ...
   - Boot selection: Select `build/rayos.iso`
...
sudo dd if=build/rayos.iso of=/dev/sdX bs=4M status=progress
sudo sync
```
...
# Eject when done:
Dismount-DiskImage -ImagePath "$(Get-Location)\build\rayos.iso"
```
...
$iso = "$(Get-Location)\build\rayos.iso"
