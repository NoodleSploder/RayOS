...
**ISO**: `iso-output/rayos-aarch64.iso` (7.88 MB)  
...
- **Output**: `iso-output/rayos-aarch64.iso` (8,265,728 bytes = 7.88 MB)
...
**Location**: `C:\Users\caden\Documents\Programming Scripts\Personal\Rust\ray-os\iso-output\rayos-aarch64.iso`
...
- `iso-output/rayos-aarch64.iso` - Bootable ISO (7.88 MB)
